...
namespace MultiFaceRec
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void button2_Click (object sender, System.EventArgs e)
        {
                try
                {
                    //MessageBox.Show("Make a " + emotions[j] + " face!!!!");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                try
                {
                    ...
                    char[] delimiterChars = { ' ', ',', '.', ':', '\t', '%'};
                    string lines = System.IO.File.ReadAllText(textBox2.Text.Trim());
                    
                    string[] todos_nomes = lines.Split(delimiterChars);

                    for (int i = 0; i < todos_nomes.Length;i++ )
                    {
                        if(strcmp(todos_nomes[i],todos_nomes[i+1]) != 0)
                        {
                            listBox1.Items.Add(todos_nomes[i]);
                        }
                    }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if(File.Exists(filePath))
            {
                ...
                MessageBox.Show("Ficheiro removido!");
            }
